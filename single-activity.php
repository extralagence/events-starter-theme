...
<div class="wrapper">
	<aside>
		<?php
		$gallery = $activity_metabox->get_the_value('gallery');
		if (empty($gallery)) :
	...
	<article class="content">
		<h1><?php the_title(); ?></h1>
		<?php the_content(); ?>
		<p><a class="button" href="<?php echo get_permalink($eventID); ?>#/activite/<?php echo $post->post_name; ?>"><?php _e("Sélectionner cette activité", "extra"); ?></a></p>
	</article>
</div><!-- .wrapper -->
...
<div class="wrapper associations">
	...
	if ( $connected->have_posts() ) : ?>
		...
		<h2><?php _e("Restaurants associés", "extra"); ?></h2>
