...
<div id="em-booking" class="em-booking">
	...
	<?php if( is_object($EM_Booking) && !get_option('dbem_bookings_double') ): //Double bookings not allowed ?>
		<div class="text-only">
			<h3><?php echo get_option('dbem_bookings_form_msg_attending'); ?></h3>
			<p><a class="button" href="<?php echo em_get_my_bookings_url(); ?>"><?php echo get_option('dbem_bookings_form_msg_bookings_link'); ?></a></p>
		</div>
